...
void G5P_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  Point->canFreeData = false;
  *plhs = emlrt_marshallOut(Point);
  emxFree_real_T(&st, &Point);
...
/*
 * File trailer for _coder_G5P_api.c
 *
 * [EOF]
 */
