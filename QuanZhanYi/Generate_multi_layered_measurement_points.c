                                               ...
                                               emxArray_real_T *Point_test)
{
  ...
  for (ib = 0; ib < firstBlockLength; ib++) {
    y->data[ib] = Point_out->data[3 * ib + 1];
  }
  emxInit_real_T(&z, 1);
  firstBlockLength = Point_out->size[1];
  ib = z->size[0];
  ...
  for (ib = 0; ib < firstBlockLength; ib++) {
    z->data[ib] = Point_out->data[3 * ib + 2];
  }
  ...
  emxEnsureCapacity_real_T(Dist, ib);
  for (ib = 0; ib < firstBlockLength; ib++) {
    Dist->data[ib] = Point_out1->data[3 * ib] * Radius + p12f_idx_1;
  }
  ...
  for (ib = 0; ib < firstBlockLength; ib++) {
    Ylay0->data[ib] = Point_out1->data[3 * ib + 1] * Radius + p2_idx_2;
  }
  ...
  for (ib = 0; ib < firstBlockLength; ib++) {
    Zlay0->data[ib] = Point_out1->data[3 * ib + 2] * Radius + p2_idx_0;
  }
  ...
  firstBlockLength = x->size[0];
  for (ib = 0; ib < firstBlockLength; ib++) {
    Point_test->data[3 * ib] = x->data[ib];
  }
  emxFree_real_T(&x);
  firstBlockLength = y->size[0];
  for (ib = 0; ib < firstBlockLength; ib++) {
    Point_test->data[3 * ib + 1] = y->data[ib];
  }
  emxFree_real_T(&y);
  firstBlockLength = z->size[0];
  for (ib = 0; ib < firstBlockLength; ib++) {
    Point_test->data[3 * ib + 2] = z->data[ib];
  }
  emxFree_real_T(&z);
}
