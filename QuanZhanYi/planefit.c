              ...
              emxArray_real_T *PlaneParaOut, emxArray_real_T *TrianglePoints)
{
  ...
  if (PlaneParaIn->size[1] == 0) {
    ...
    CrossLine(*(double(*)[4]) & PlaneParaIn_data[0],
              *(double(*)[4]) & PlaneParaIn_data[4], x_val, coefficients, D);
    /*  找到边界，确定三角点 */
    b_GenerateTrianglePoints(*(double(*)[4]) & x_data[0], BoundPoint1,
                             coefficients, D, PointTri);
    b_xfit[0] = PointTri[0];
    b_yfit[0] = PointTri[1];
    zfit[0] = PointTri[2];
    b_xfit[1] = PointTri[3];
    b_yfit[1] = PointTri[4];
    zfit[1] = PointTri[5];
    b_GenerateTrianglePoints(*(double(*)[4]) & x_data[0], BoundPoint2,
                             coefficients, D, PointTri);
    b_xfit[2] = PointTri[0];
    b_yfit[2] = PointTri[1];
    zfit[2] = PointTri[2];
    ...
    CrossLine(*(double(*)[4]) & x_data[4], *(double(*)[4]) & x_data[8], x_val,
              coefficients, D);
    /*  找到边界，确定三角点 */
    b_GenerateTrianglePoints(*(double(*)[4]) & x_data[8], BoundPoint1,
                             coefficients, D, PointTri);
    b_xfit[4] = PointTri[0];
    b_yfit[4] = PointTri[1];
    zfit[4] = PointTri[2];
    ...
    b_yfit[6] = PointTri[4];
    zfit[6] = PointTri[5];
    b_GenerateTrianglePoints(*(double(*)[4]) & x_data[8], BoundPoint2,
                             coefficients, D, PointTri);
    b_xfit[5] = PointTri[0];
    b_yfit[5] = PointTri[1];
    zfit[5] = PointTri[2];
    ...
    CrossLine(*(double(*)[4]) & x_data[8], *(double(*)[4]) & x_data[12], x_val,
              coefficients, D);
    b_GenerateTrianglePoints(*(double(*)[4]) & x_data[12], BoundPoint1,
                             coefficients, D, PointTri);
    b_xfit[6] = PointTri[0];
    b_yfit[6] = PointTri[1];
    zfit[6] = PointTri[2];
    b_GenerateTrianglePoints(*(double(*)[4]) & x_data[12], BoundPoint2,
                             coefficients, D, PointTri);
    b_xfit[7] = PointTri[0];
    b_yfit[7] = PointTri[1];
    zfit[7] = PointTri[2];
