...
static void main_cylderfit(void);
...
static void main_cylderfit(void)
{
  ...
  double x_tmp[45];
  emxInitArray_real_T(&retrn, 2);
  /* Initialize function 'cylderfit' input arguments. */
  /* Initialize function input argument 'x'. */
  argInit_45x1_real_T(x_tmp);
  /* Initialize function input argument 'y'. */
  /* Initialize function input argument 'z'. */
  /* Call the entry-point 'cylderfit'. */
  cylderfit(x_tmp, x_tmp, x_tmp, retrn);
  emxDestroyArray_real_T(retrn);
}
