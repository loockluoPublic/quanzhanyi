 ...
 * Return Type  : void
 */
void emxFreeStruct_pointCloud1(pointCloud *pStruct)
{
 ...
 * Return Type  : void
 */
void emxInitStruct_pointCloud1(pointCloud *pStruct)
{
