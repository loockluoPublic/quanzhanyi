/*
 * File: _coder_Generate_multi_layered_measurement_points_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "Generate_multi_layered_measurement_points",          /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *num,
                                 const char_T *identifier);

static real_T d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                 const emlrtMsgIdentifier *parentId);

static real_T (*e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *P3,
                                   ...
                                   const char_T *identifier))[3]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = f_emlrt_marshallIn(sp, emlrtAlias(P3), &thisId);
  emlrtDestroyArray(&P3);
  return y;
}
...
void Generate_multi_layered_measurement_points_atexit(void)
{
  ...
  Generate_multi_layered_measurement_points_xil_terminate();
  Generate_multi_layered_measurement_points_xil_shutdown();
                                     ...
                                     const mxArray **plhs)
{
  ...
  num = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "num");
  laynum = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "laynum");
  P3 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[5]), "P3");
  P4 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[6]), "P4");
...
/*
 * File trailer for _coder_Generate_multi_layered_measurement_points_api.c
 *
 * [EOF]
 */
