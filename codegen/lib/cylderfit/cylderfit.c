 ...
 * Return Type  : void
 */
void cylderfit(const emxArray_real_T *x, const emxArray_real_T *y,
               const emxArray_real_T *z, double *xn1, double *xn2, double *xn3,
               double *xn4, double *xn5, double *xn6, double *xn7)
{
  void *locationPtr;
  emxArray_real_T *Bn;
  emxArray_real_T *L;
