function Point_test = Generate_multi_layered_measurement_points(Point_out,num,laynum,P3,P4,r)
%% -----------------------平均轴向量、圆心-----------------------
x = Point_out(1,:)';
y = Point_out(2,:)';
z = Point_out(3,:)';
...
Point_out1 = generate_unit_circle_with_normal_vector(elevation,azimuth,num,r);
Xgen = Point_out1(1,:);
Ygen = Point_out1(2,:);
Zgen = Point_out1(3,:);
