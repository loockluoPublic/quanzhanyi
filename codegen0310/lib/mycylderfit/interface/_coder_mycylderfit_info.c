/*
 * File: _coder_mycylderfit_info.c
 *
...
/* Include Files */
#include "_coder_mycylderfit_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"mycylderfit"));
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"FullPath",
                emlrtMxCreateString(
                    (const char_T *)"C:\\Users\\Administrator\\Desktop\\qzy_"
                                    "matlab\\update_function\\mycylderfit.m"));
  emlrtSetField(xEntryPoints, 0, (const char_T *)"TimeStamp",
                emlrtMxCreateDoubleScalar(739314.94413194444));
  xResult =
...
/*
 * File trailer for _coder_mycylderfit_info.c
 *
 * [EOF]
 */
