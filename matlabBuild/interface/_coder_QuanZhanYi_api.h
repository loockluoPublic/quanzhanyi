...
void Calculat_A_and_B_Points_after_Offest2(
    ...
    emxArray_real_T *roff, emxArray_real_T *PointTable_A_off2,
    emxArray_real_T *PointTable_B_off2, emxArray_real_T *BianHao);
...
void Calculate_rectangle_from_vertex8(
    ...
    emxArray_real_T *XieMianPianYi, emxArray_real_T *BianHao);
...
void generate_unit_circle_with_normal_vector2(emxArray_real_T *PointIn,
                                              real_T num, real_T laynum,
                                              real_T PUp[3], real_T PDown[3],
                                              emxArray_real_T *Point_out);
...
void planefit8(emxArray_real_T *Points1, emxArray_real_T *Points2,
               ...
               emxArray_real_T *PlaneParaOut, emxArray_real_T *TrianglePoints,
               real_T MaxDis[8], emxArray_real_T *tt1, emxArray_real_T *tt2,
               emxArray_real_T *tt3, emxArray_real_T *tt4, emxArray_real_T *tt5,
               emxArray_real_T *tt6, emxArray_real_T *tt7, emxArray_real_T *tt8,
               real_T LenDaoJiao[8]);
